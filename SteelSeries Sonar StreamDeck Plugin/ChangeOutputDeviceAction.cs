...
{
    [PluginActionId("com.rydersir.sonargg.changeoutputdevice")]
    public class ChangeOutputDeviceAction : KeypadBase
    {
        ...
        #endregion
        public ChangeOutputDeviceAction(SDConnection connection, InitialPayload payload) : base(connection, payload)
        {
